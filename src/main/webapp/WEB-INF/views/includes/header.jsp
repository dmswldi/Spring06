        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/resources/login.html">Login</a>
                    <a class="collapse-item" href="/resources/register.html">Register</a>
                    <a class="collapse-item" href="/resources/forgot-password.html">Forgot Password</a>
                    <div class="collapse-divider"></div>
                    <h6 class="collapse-header">Other Pages:</h6>
                    <a class="collapse-item" href="/resources/404.html">404 Page</a>
                    <a class="collapse-item" href="/resources/blank.html">Blank Page</a>
                </div>
            </div>
        </li>
